...
class bot:
    ...
    async def instantiate(self: bot, __backend: AbstractBackend = ..., /, *, loop: AbstractEventLoop, **arguments: Any) -> _bot_instance: ...
...
class _bot_instance:
    ...
    def __del__(self: _bot_instance, /) -> None: ...

    @property
    def globals(self: _bot_instance, /) -> _bot_globals: ...
...
@overload
def depends_on(component_or_bot: _bot_instance | _bot_globals | _component_instance | _component_super_layer, dependency: component | _component_instance, /) -> bool: ...
